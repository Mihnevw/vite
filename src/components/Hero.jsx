  ...
  return (
    <>
      ...
      <section className="flex flex-col lg:flex-row items-center justify-around p-10 space-y-10 lg:space-y-0 text-white">
        ...
        >
          <p className="text-4xl font-bold text-gray-400">I&apos;m</p>
        ...
        >
          <img
            src={Profileimg}
            alt="Profile"
            className="rounded-full w-60 border-8 border-indigo-500 shadow-lg"
          />
        </motion.div>
        ...
        >
          ...
          <button
            ...
            className="mt-5 px-8 py-2 bg-indigo-500 text-white rounded-full font-bold hover:bg-indigo-700 transition-all"
          >
          ...
          <div className="flex justify-center lg:justify-start mt-6 space-x-4">
            <Link to="https://www.facebook.com/stilian.mihnev" target="_blank" aria-label="Facebook">
              <BsFacebook size={40} className="text-white hover:text-indigo-500 transition-all" />
            </Link>
            <Link to="https://x.com/home/" target="_blank" aria-label="Twitter">
              <BsTwitter size={40} className="text-white hover:text-indigo-500 transition-all" />
            </Link>
            <Link to="https://www.instagram.com/mihnevw/" target="_blank" aria-label="Instagram">
              <BsInstagram size={40} className="text-white hover:text-indigo-500 transition-all" />
            </Link>
            <Link to="https://github.com/Mihnevw/" target="_blank" aria-label="GitHub">
              <BsGithub size={40} className="text-white hover:text-indigo-500 transition-all" />
            </Link>
          </div>
        </motion.div>
      </section>
