      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 max-w-6xl mx-auto">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold text-gray-100">Mihnev</h3>
          ...
          <div className="space-y-4">
            ...
            <nav className="flex flex-col space-y-2">
              {['skill', 'projects', 'resume', 'contact'].map((link, index) => (
                <Link 
                  key={index} 
                  to={`/${link}`} 
                  className="hover:text-blue-400 transition duration-300 ease-in-out transform hover:translate-x-1"
                >
